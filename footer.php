<footer class="site-footer">
    ...
    <ul class="links">
        <li><a href="https://www.facebook.com/kocmoc.radio/" target="_blank" rel="noopener noreferrer">Facebook</a></li>
        <li><a href="https://www.instagram.com/kocmoc.live/" target="_blank" rel="noopener noreferrer">Instagram</a></li>
        <li><a href="https://soundcloud.com/kocmoclive" target="_blank" rel="noopener noreferrer">Soundcloud</a></li>
        <li><a href="https://github.com/kocmoc-collective" target="_blank" rel="noopener noreferrer">GitHub</a></li>
    </ul>

    <div class="cc">
        CC BY-NC-SA 4.0. 2011-2022.
    </div>
...
<script src="src/js/app.js?ver=1.0.0"></script>
<?php if ($page == "Schedule") : ?>
    <script src="src/js/schedule.js?ver=1.0.0"></script>
<?php endif ?>
</body>
